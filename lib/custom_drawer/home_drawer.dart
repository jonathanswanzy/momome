import 'package:momome/app_theme.dart';
...
class _HomeDrawerState extends State<HomeDrawer> {
  ...
  void setdDrawerListArray() {
    drawerList = <DrawerList>[
      ...
      DrawerList(
        index: DrawerIndex.GMBPhoto,
        labelName: 'GMB Photos',
              ...
              child: Row(
                children: <Widget>[
                  ...
                  listData.isAssetsImage
                    ...
                    width: 24,
                    height: 24,
                    child: Image.asset(listData.imageName, color: widget.screenIndex == listData.index ? Colors.brown : AppTheme.nearlyBlack),
                  )
                      : Icon(listData.icon.icon, color: widget.screenIndex == listData.index ? Colors.brown : AppTheme.nearlyBlack),
                  const Padding(
                    padding: EdgeInsets.all(4.0),
                  ),
                  Text(
                    ...
                    style: TextStyle(
                      ...
                      fontSize: 16,
                      color: widget.screenIndex == listData.index ? Colors.brown : AppTheme.nearlyBlack,
                    ),
                    textAlign: TextAlign.left,
                  ),
                ],
